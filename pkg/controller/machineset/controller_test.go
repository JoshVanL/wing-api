...
import (
	...
	. "github.com/jetstack/wing-api/pkg/client/clientset_generated/clientset/typed/wing/v1alpha1"
...
var _ = Describe("MachineSet controller", func() {
	var instance MachineSet
	var expectedKey string
	var client MachineSetInterface
	...
	BeforeEach(func() {
		...
		expectedKey = "machineset-controller-test-handler/instance-1"
	})
	...
	Describe("when creating a new object", func() {
		It("invoke the reconcile method", func() {
			client = cs.WingV1alpha1().MachineSets("machineset-controller-test-handler")
